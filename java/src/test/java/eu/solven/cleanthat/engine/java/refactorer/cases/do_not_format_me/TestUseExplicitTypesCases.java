...
import eu.solven.cleanthat.engine.java.refactorer.mutators.UseExplicitTypes;
import eu.solven.cleanthat.engine.java.refactorer.test.AJavaparserRefactorerCases;

public class TestUseExplicitTypesCases extends AJavaparserRefactorerCases {
    @Override
    public IJavaparserAstMutator getTransformer() {
        return new UseExplicitTypes();
    }
    ...
    // If the variable type is replaced by var, it takes the initial type, which may
    // not be compatible with further
    // allocation
    @UnmodifiedMethod
